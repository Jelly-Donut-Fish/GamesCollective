...
function MyCollectionSearch({ myCollection, setFilters, getMyCollection }) {
  ...
  return (
    <div>
      ...
      <label htmlFor="genre">
        <select name="filters" id="genre" value="Action" onChange={filterHandler} className="innerFilter">
      ...
      <label htmlFor="category">
        <select name="filters" id="category" value="Co-op" onChange={filterHandler} className="innerFilter">
      ...
      <label htmlFor="status">
        <select name="filters" id="status" value="Playing" onChange={filterHandler} className="innerFilter">
