      ...
      {myCollection.length === 0 ? (
        ...
        <div className="list">
          {myCollection.length > 1 && myCollection.map((game, i) => {
            console.log('collection length ', myCollection);
            const tile = (
              <MyCollectionTile
                key={game.id}
                game={game}
            ...
            const genreField = document
              ...
              document.getElementById("genre").value.toLowerCase() : "Action";
            const categoryField = document
              .getElementById("category") ? document
              .getElementById("category").value.toLowerCase() : "Co-op";
